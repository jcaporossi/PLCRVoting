...
const EIP20 = artifacts.require('./PLCRToken');
...
contract('PLCRVoting', (accounts) => {
  describe('Function: commitVote', () => {
    ...
    before(async () => {
      ...
      const receipt = await plcrFactory.newPLCRWithToken(10000, 'TestToken', 'TEST');
    ...
    it('should request for voting rights if voteTokenBalance is less than numTokens', async () => {
      ...
      options.numTokens = startingBalance.add(new web3.utils.BN(1)).toString();   
      ...
      assert(endingBalance.toString(), startingBalance.add(new web3.utils.BN(1)).toString(),
